...
//    ros::Subscriber sub_vel = nh.subscribe( "cmd_vel" ,1000,&cmdVelCallback);
    ...
    sonar_cloud[0][0] = info->config_param.base_conf.base_snoars[0].x_to_center_mm + sonar_maxval * cos(DEG2RAD(info->config_param.base_conf.base_snoars[0].anti_clockwise_angle_to_center_degree));
    sonar_cloud[0][1] = info->config_param.base_conf.base_snoars[0].y_to_center_mm + sonar_maxval * sin(DEG2RAD(info->config_param.base_conf.base_snoars[0].anti_clockwise_angle_to_center_degree));
    sonar_cloud[0][2] = sonar_height;

    sonar_cloud[1][0] = info->config_param.base_conf.base_snoars[1].x_to_center_mm + sonar_maxval * cos(DEG2RAD(info->config_param.base_conf.base_snoars[1].anti_clockwise_angle_to_center_degree));
    sonar_cloud[1][1] = info->config_param.base_conf.base_snoars[1].y_to_center_mm + sonar_maxval * sin(DEG2RAD(info->config_param.base_conf.base_snoars[1].anti_clockwise_angle_to_center_degree));
    sonar_cloud[1][2] = sonar_height;

    sonar_cloud[2][0] = info->config_param.base_conf.base_snoars[2].x_to_center_mm + sonar_maxval * cos(DEG2RAD(info->config_param.base_conf.base_snoars[2].anti_clockwise_angle_to_center_degree));
    sonar_cloud[2][1] = info->config_param.base_conf.base_snoars[2].y_to_center_mm + sonar_maxval * sin(DEG2RAD(info->config_param.base_conf.base_snoars[2].anti_clockwise_angle_to_center_degree));
    sonar_cloud[2][2] = sonar_height;

    sonar_cloud[3][0] = info->config_param.base_conf.base_snoars[3].x_to_center_mm + sonar_maxval * cos(DEG2RAD(info->config_param.base_conf.base_snoars[3].anti_clockwise_angle_to_center_degree));
    sonar_cloud[3][1] = info->config_param.base_conf.base_snoars[3].y_to_center_mm + sonar_maxval * sin(DEG2RAD(info->config_param.base_conf.base_snoars[3].anti_clockwise_angle_to_center_degree));
    sonar_cloud[3][2] = sonar_height;

    sonar_cloud[4][0] = info->config_param.base_conf.base_snoars[4].x_to_center_mm + sonar_maxval * cos(DEG2RAD(info->config_param.base_conf.base_snoars[4].anti_clockwise_angle_to_center_degree));
    sonar_cloud[4][1] = info->config_param.base_conf.base_snoars[4].y_to_center_mm + sonar_maxval * sin(DEG2RAD(info->config_param.base_conf.base_snoars[4].anti_clockwise_angle_to_center_degree));
    ...
    while (ros::ok()) {
        try{
            ...
            if(sonar0_range.range >= 0.5f || sonar0_range.range == 0.0f){
                ...
                sonar_cloud[0][0] = info->config_param.base_conf.base_snoars[0].x_to_center_mm + sonar0_range.range * cos(DEG2RAD(info->config_param.base_conf.base_snoars[0].anti_clockwise_angle_to_center_degree));
                sonar_cloud[0][1] = info->config_param.base_conf.base_snoars[0].y_to_center_mm + sonar0_range.range * sin(DEG2RAD(info->config_param.base_conf.base_snoars[0].anti_clockwise_angle_to_center_degree));
            }
            ...
            if(sonar1_range.range >= 0.5f || sonar1_range.range == 0.0f){
                ...
                sonar_cloud[1][0] = info->config_param.base_conf.base_snoars[1].x_to_center_mm + sonar1_range.range * cos(DEG2RAD(info->config_param.base_conf.base_snoars[1].anti_clockwise_angle_to_center_degree));
                sonar_cloud[1][1] = info->config_param.base_conf.base_snoars[1].y_to_center_mm + sonar1_range.range * sin(DEG2RAD(info->config_param.base_conf.base_snoars[1].anti_clockwise_angle_to_center_degree));
            }
            ...
            if(sonar2_range.range >= 0.5f || sonar2_range.range == 0.0f){
                ...
                sonar_cloud[2][0] = info->config_param.base_conf.base_snoars[2].x_to_center_mm + sonar2_range.range * cos(DEG2RAD(info->config_param.base_conf.base_snoars[2].anti_clockwise_angle_to_center_degree));
                sonar_cloud[2][1] = info->config_param.base_conf.base_snoars[2].y_to_center_mm + sonar2_range.range * sin(DEG2RAD(info->config_param.base_conf.base_snoars[2].anti_clockwise_angle_to_center_degree));
            }
            ...
            if(sonar3_range.range >= 0.5f || sonar3_range.range == 0.0f){
                ...
                sonar_cloud[3][0] = info->config_param.base_conf.base_snoars[3].x_to_center_mm + sonar3_range.range * cos(DEG2RAD(info->config_param.base_conf.base_snoars[3].anti_clockwise_angle_to_center_degree));
                sonar_cloud[3][1] = info->config_param.base_conf.base_snoars[3].y_to_center_mm + sonar3_range.range * sin(DEG2RAD(info->config_param.base_conf.base_snoars[3].anti_clockwise_angle_to_center_degree));
            }
            ...
            if(sonar4_range.range >= 0.5f || sonar4_range.range == 0.0f){
                ...
                sonar_cloud[4][0] = info->config_param.base_conf.base_snoars[4].x_to_center_mm + sonar4_range.range * cos(DEG2RAD(info->config_param.base_conf.base_snoars[4].anti_clockwise_angle_to_center_degree));
                sonar_cloud[4][1] = info->config_param.base_conf.base_snoars[4].y_to_center_mm + sonar4_range.range * sin(DEG2RAD(info->config_param.base_conf.base_snoars[4].anti_clockwise_angle_to_center_degree));
            }
